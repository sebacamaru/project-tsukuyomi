import{a as e,o as t}from"./index-D8PBEQHq.js";import{n,t as r}from"./Scene-B0WgXyFJ.js";import{t as i}from"./assetRegistry-nONwpp3R.js";var a=`<div class="inventory">
    <div class="container">
...
`,o=class{constructor(e){this.container=typeof e.container==`string`?document.querySelector(e.container):e.container,this.items=e.items||[],this.filteredItems=[...this.items],this.onItemClick=e.onItemClick||null,this.showQuantity=e.showQuantity!==!1,this.emptyMessage=e.emptyMessage||`Sin items`,this.emptyElement=e.emptyElement||null,this.lazyLoadRoot=e.lazyLoadRoot||this.container,this.tooltip=null,this.activeItem=null,this.isMobile=`ontouchstart`in window||navigator.maxTouchPoints>0,this.hideTooltipTimeout=null,this.listeners=[],this.init()}init(){this.createTooltip(),this.setupEvents()}createTooltip(){document.body.insertAdjacentHTML(`beforeend`,`
    ...
    `}setItems(e){this.items=e||[],this.filteredItems=[...this.items],this.render()}filter(e){e===`all`?this.filteredItems=[...this.items]:this.filteredItems=this.items.filter(t=>t.type===e),this.render()}getItemData(e){let t=parseInt(e.dataset.inventoryId);return this.items.find(e=>e.id===t)}on(e,t,n,r=!1){e.addEventListener(t,n,r),this.listeners.push({element:e,event:t,handler:n,useCapture:r})}destroy(){this.hideTooltipTimeout&&clearTimeout(this.hideTooltipTimeout),this.listeners.forEach(({element:e,event:t,handler:n,useCapture:r})=>{e.removeEventListener(t,n,r)}),this.listeners=[],this.tooltip&&=(this.tooltip.remove(),null),this.activeItem=null}},s=class extends r{constructor(){super(),this.itemGrid=null}async getHTML(){return a}async initUI(){await e.loadInventory(),this.updateGold(),this.itemGrid=new o({container:this.$(`#inventoryItems`),items:t.inventory,showQuantity:!0,emptyElement:this.$(`#emptyMessage`),lazyLoadRoot:this.root}),this.itemGrid.render(),this.onClick(`.tab`,(e,t)=>{this.$$(`.tab`).forEach(e=>e.classList.remove(`active`)),t.classList.add(`active`),this.itemGrid.filter(t.dataset.type)})}updateGold(){let e=this.$(`#goldAmount`);e&&(e.textContent=t.gold.toLocaleString())}onExit(){this.itemGrid&&=(this.itemGrid.destroy(),null),super.onExit()}};export{s as InventoryScene};